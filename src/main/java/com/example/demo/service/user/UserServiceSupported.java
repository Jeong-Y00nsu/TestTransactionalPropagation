...
@Service
@Qualifier("userServiceSupported")
public class UserServiceSupported extends UserService{
    public UserServiceSupported(UserMapper userMapper, @Qualifier("termsServiceSupported")TermsService termsService) {
