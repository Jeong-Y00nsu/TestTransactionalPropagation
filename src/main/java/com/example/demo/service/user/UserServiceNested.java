...
@Service
@Qualifier("userServiceNested")
public class UserServiceNested extends UserService{
    public UserServiceNested(UserMapper userMapper, @Qualifier("termsServiceNested")TermsService termsService) {
