...
@Service
@Qualifier("userServiceRequiresNew")
public class UserServiceRequiresNew extends UserService{
    public UserServiceRequiresNew(UserMapper userMapper, @Qualifier("termsServiceRequiresNew")TermsService termsService) {
