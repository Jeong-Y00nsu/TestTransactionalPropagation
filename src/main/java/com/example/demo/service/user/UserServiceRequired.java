...
@Service
@Qualifier("userServiceRequired")
public class UserServiceRequired extends UserService{
    public UserServiceRequired(UserMapper userMapper, @Qualifier("termsServiceRequired")TermsService termsService) {
