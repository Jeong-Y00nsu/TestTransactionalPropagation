...
@Service
@Qualifier("userServiceNever")
public class UserServiceNever extends UserService{
    public UserServiceNever(UserMapper userMapper, @Qualifier("termsServiceNever")TermsService termsService) {
